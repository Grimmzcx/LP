...
function Navbar(){
    return(
        <>
        <div className="navbar bg-emerald-400 text-black top-0 z-50">
        <div className="flex-1">
        <a href="/"className=" text-xl text-green-500 mx-10"><img src={logo} className=' rounded-full w-10 h-10'/></a>
        <div>
        ...
        <div className="font-bold">
            ...
            <li><Link to="1" smooth={true} duration={1000} className="hover:text-gray-300 cursor-pointer bg-gray-400">Home</Link></li>
